/**
 * DynamoDB implementation of IStorage. Extracted verbatim from the original
 * `server/storage.ts` so local-dev behavior is unchanged: when DB_BACKEND
 * is unset or set to "dynamo", this is the backend that runs.
 */
